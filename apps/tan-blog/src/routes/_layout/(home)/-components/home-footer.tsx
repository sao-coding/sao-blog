  ...
  return (
    ...
    >
      ...
      <div className="mt-12 flex items-stretch justify-center divide-x divide-neutral-10/10">
        <Link to="/notes" className="group px-8">
        ...
        <Link to="/thinking" className="group px-8 text-left">
          <p className="text-sm text-neutral-10/50 transition-colors group-hover:text-primary">
            訂閱通信
          </p>
      ...
      <nav className="mt-16 flex items-center justify-center gap-3 text-sm text-neutral-10/40">
        <Link to="/posts" className="transition-colors hover:text-primary">
          文章
        </Link>
        ...
        <span aria-hidden>·</span>
        <Link to="/thinking" className="transition-colors hover:text-primary">
          想法
        </Link>
        <span aria-hidden>·</span>
        <Link to="/timeline" className="transition-colors hover:text-primary">
          時光
        </Link>
      </nav>
    </motion.section>
