...
declare const appRouter: {
  ...
  admin: {
    post: {
      ...
      getPost: _orpc_server0.Procedure<_orpc_server0.MergedInitialContext<{
        session: {
          session: {
            id: string;
            createdAt: Date;
      ...
      createPost: _orpc_server0.Procedure<_orpc_server0.MergedInitialContext<{
        session: {
          session: {
            id: string;
            createdAt: Date;
        ...
        title: zod0.ZodString;
        content: zod0.ZodString;
        summary: zod0.ZodOptional<zod0.ZodString>;
        category: zod0.ZodOptional<zod0.ZodString>;
        tags: zod0.ZodOptional<zod0.ZodArray<zod0.ZodString>>;
        cover: zod0.ZodOptional<zod0.ZodString>;
        allowComments: zod0.ZodDefault<zod0.ZodBoolean>;
        pin: zod0.ZodDefault<zod0.ZodBoolean>;
        pinOrder: zod0.ZodDefault<zod0.ZodNumber>;
    ...
    category: {
      getCategories: _orpc_server0.Procedure<_orpc_server0.MergedInitialContext<{
        session: {
          session: {
            id: string;
            createdAt: Date;
      ...
      getCategory: _orpc_server0.Procedure<_orpc_server0.MergedInitialContext<{
        session: {
          session: {
            id: string;
            createdAt: Date;
      ...
      createCategory: _orpc_server0.Procedure<_orpc_server0.MergedInitialContext<{
        session: {
          session: {
            id: string;
            createdAt: Date;
      ...
      updateCategory: _orpc_server0.Procedure<_orpc_server0.MergedInitialContext<{
        session: {
          session: {
            id: string;
            createdAt: Date;
        ...
        description: zod0.ZodNullable<zod0.ZodString>;
        color: zod0.ZodNullable<zod0.ZodString>;
      }, better_auth0.$strip>, _orpc_server0.Schema<void, void>, _orpc_server0.MergedErrorMap<Record<never, never>, Record<never, never>>, Record<never, never>>;
    };
    tag: {
      getTags: _orpc_server0.Procedure<_orpc_server0.MergedInitialContext<{
        session: {
          session: {
            id: string;
            createdAt: Date;
