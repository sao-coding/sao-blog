...
const getPosts = publicProcedure.output(PostsResponseSchema).handler(async () => {
...
const createPost = protectedProcedure.input(createPostSchema).handler(async ({ input, context }) => {
